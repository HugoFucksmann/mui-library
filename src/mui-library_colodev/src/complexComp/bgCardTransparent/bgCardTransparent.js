import "./bgCardTransparent.css";

const BgCardTransparent = () => {
  return (
    <>
      <div class='fs'>
        <div class='hold-illustration w-preserve-3d'>
          <div class='background w-clearfix'>
            ...
            <div class='text-like-box w-clearfix'>
              <div class='text' data-ix='arrow-load'>
                A
              </div>
              <div class='straight-line' data-ix='arrow-load'></div>
              <div
                class='straight-line-full'
                data-ix='loading-line-animation'></div>
              <div
                class='straight-line-full'
                data-ix='loading-line-animation-2'></div>
              <div
                class='straight-line-full'
                data-ix='loading-line-animation-3'></div>
              <div
                class='straight-line-full'
                data-ix='loading-line-animation-6-long'></div>
              <div
                class='straight-line-full'
                data-ix='loading-line-animation-5'></div>
              <div
                class='shortened straight-line-full'
                data-ix='loading-line-animation-6shorted'></div>
            </div>
            <div class='mountain-photo-parent'>
              <div class='mountain-photo__real-deal' data-ix='arrow-load'>
                <div
                  class='mountain'
                  data-ix='mountain-slide-in-from-left'></div>
            ...
            <div class='square-tower' data-ix='arrow-load'>
              <div
                class='play-box w-preserve-3d'
                data-ix='tower-hover-animation'>
                <div class='play-box__top-bar'></div>
                <a class='overflow-hidden w-inline-block w-lightbox' href='#'>
                  <div
                    class='play-box__play-icon'
                    data-ix='play-icon-on-load'></div>
                </a>
              </div>
            ...
            <div class='tri-parent w-clearfix'>
              ...
              <div class='column' data-ix='column-hover-2'>
                ...
                <div
                  class='straight-line-full'
                  data-ix='loading-line-animation'>
                  <div class='straight-line-full'></div>
                </div>
                <div
                  class='straight-line-full'
                  data-ix='loading-line-animation-2'>
                  <div class='straight-line-full'></div>
                </div>
                <div
                  class='straight-line-full'
                  data-ix='loading-line-animation-3'>
                  <div class='straight-line-full'></div>
                </div>
              </div>
              ...
              <div
                class='bottom text-like-box v2 w-clearfix'
                data-ix='column-hover'>
                <div
                  class='straight-line-full'
                  data-ix='loading-line-animation'></div>
                <div
                ...
                <div
                  class='shortened straight-line-full'
                  data-ix='loading-line-animation-4-shortened'></div>
                <div
                  class='mountain-photo__real-deal small'
                  data-ix='column-hover'>
                  <div
                    class='mountain shrunked'
                    data-ix='mountain-slide-in-from-left'></div>
                  <div
                    class='_2 mountain shrunked'
                    data-ix='mountain-slide-in'></div>
                </div>
                <div
                  class='mountain-photo__real-deal no-mountains small'
                  data-ix='column-hover'></div>
              </div>
            </div>
...
export default BgCardTransparent;
